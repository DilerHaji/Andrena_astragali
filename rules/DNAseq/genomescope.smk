rule genomescope:
    ...
    output:
       summary="{sample}_genomescope_results/summary.txt",
       count_jf="{sample}_count.jf",
       hist="{sample}.histo"
    params: 
       threads=20,
       memory="50G",
    ...
    shell:
       ...
       jellyfish histo -t {params.threads} {output.count_jf} > {output.histo}
       
       Rscript /global/scratch/users/diler/scripts/genomescope.R {output.histo} {params.kmer_size} {params.read_length} {wildcards.sample}_genomescope_results
